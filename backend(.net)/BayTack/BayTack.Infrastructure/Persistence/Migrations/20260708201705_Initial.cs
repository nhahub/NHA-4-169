        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressCityId = table.Column<int>(type: "int", nullable: true),
                    AddressAreaId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Favorites_AspNetUsers_ProviderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkshopAddressDetails = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WorkshopCityId = table.Column<int>(type: "int", nullable: true),
                    WorkshopAreaId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinPriceCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    MaxPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MaxPriceCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProviderDocuments_AspNetUsers_ReviewedBy",
                        column: x => x.ReviewedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProviderDocuments_ProviderProfiles_ProviderProfileId",
                        column: x => x.ProviderProfileId,
                        principalTable: "ProviderProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationAreaId = table.Column<int>(type: "int", nullable: true),
                    PreferredPayment = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerJobs_AspNetUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomerJobs_AspNetUsers_DeletedBy",
                        column: x => x.DeletedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomerJobs_Services_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicePaymentMethods", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServicePaymentMethods_PaymentMethods_PaymentMethodId",
                        column: x => x.PaymentMethodId,
                        principalTable: "PaymentMethods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServicePaymentMethods_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CustomerJobId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobImages_CustomerJobs_CustomerJobId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_CustomerJobs_CustomerJobId",
                        column: x => x.CustomerJobId,
                        principalTable: "CustomerJobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProposedPriceCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProviderBids_AspNetUsers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProviderBids_CustomerJobs_CustomerJobId",
                        column: x => x.CustomerJobId,
                        principalTable: "CustomerJobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OurCommission = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CommissionCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    ProviderReceived = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ProviderReceivedCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerJobs_DeletedBy",
                table: "CustomerJobs",
                column: "DeletedBy");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerJobs_ServiceId",
                table: "CustomerJobs",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Favorites_CustomerId_ProviderId",
                table: "Favorites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobImages_CustomerJobId",
                table: "JobImages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProviderBids_CustomerJobId_ProviderId_Status",
                table: "ProviderBids",
                columns: new[] { "CustomerJobId", "ProviderId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_ProviderBids_ProviderId",
                table: "ProviderBids",
                column: "ProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_ProviderDocuments_ProviderProfileId",
                table: "ProviderDocuments",
                column: "ProviderProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ProviderDocuments_ReviewedBy",
                table: "ProviderDocuments",
                column: "ReviewedBy");

            migrationBuilder.CreateIndex(
                name: "IX_ProviderPortfolioItems_ProviderProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServicePaymentMethods_PaymentMethodId",
                table: "ServicePaymentMethods",
                column: "PaymentMethodId");

            migrationBuilder.CreateIndex(
                name: "IX_ServicePaymentMethods_ServiceId_PaymentMethodId",
                table: "ServicePaymentMethods",
                columns: new[] { "ServiceId", "PaymentMethodId" },
                unique: true);
